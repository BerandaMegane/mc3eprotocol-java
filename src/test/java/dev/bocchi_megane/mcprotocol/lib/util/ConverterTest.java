...
public class ConverterTest {
    ...
    public void testConcatByteArrays() {
        ...
        byte[] result = Converter.concatByteArrays(array1, array2, array3);
    ...
    public void testConcatByteArraysSingleArray() {
        ...
        byte[] result = Converter.concatByteArrays(array1);
        assertArrayEquals(expected, result);
    }
    ...
    public void testToLittleEndianBytesInt_len4_0() {
        ...
        byte[] result = Converter.fromIntToByteArray(value, length);
        assertArrayEquals(expected, result);
    }
